      ...
      <div style={c.main}>
        ...
        <div style={c.sidebar}>
          <div>
            ...
            <div style={c.divider} />
            <p style={c.aboutP}><strong style={{ color: 'var(--text)' }}>off record</strong> is for men.</p>
            <p style={{ ...c.aboutP, color: 'var(--text-muted)', fontSize: 12 }}>everyone&apos;s welcome to listen.</p>
